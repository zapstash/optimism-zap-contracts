...
function domainSeparator(name, version, chainId, verifyingContract) {
    return ("0x" +
        eth_sig_util_1.TypedDataUtils.hashStruct("EIP712Domain", { name, version, chainId, verifyingContract }, { EIP712Domain: exports.EIP712Domain }).toString("hex"));
}
...
//# sourceMappingURL=zapUtil.js.map
